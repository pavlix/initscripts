...
%package conflict
Summary: Conflicting stuff from Fedora initscripts

%description conflict
This package contains conflicting stuff from Fedora initscripts.
...
%endif
%{_mandir}/man1/consoletype.1.gz
%{_mandir}/man1/genhostid.1.gz
%{_mandir}/man1/netreport.1.gz
%{_mandir}/man8/sushell.8.gz
%{_mandir}/man8/sys-unconfig.8.gz
%{_mandir}/man8/usernetctl.8.gz
...
%{_mandir}/man8/ifdown.8.gz
%{_mandir}/man8/ifup.8.gz
%{_mandir}/man8/service.8.gz
